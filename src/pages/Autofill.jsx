  ...
  return (
    <div className="max-w-[800px] mx-auto p-4 md:p-8">
      <div className="flex items-center gap-6 mb-10">
        <button onClick={() => nav(-1)} className="p-3 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl hover:bg-slate-50 dark:hover:bg-white/10 transition-all group">
      ...
      <section className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-8 shadow-sm mb-10">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button onClick={autoFill} disabled={loading} className="bg-primary text-white px-8 py-4 rounded-2xl font-black flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-primary/20 disabled:opacity-60 whitespace-nowrap">
              {loading ? (
      ...
      <form className="space-y-8" onSubmit={submit}>
        ...
        <div className="flex items-center justify-end gap-4 pt-10">
          <button type="button" onClick={() => nav(-1)} className="px-8 py-3 rounded-2xl font-bold text-slate-400 hover:bg-slate-50 dark:hover:bg-white/5 transition-all">Cancel</button>
          <button type="submit" className="bg-primary text-white px-10 py-3 rounded-2xl font-bold shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all">Save Application</button>
        </div>
      </form>
    </div>
  );
